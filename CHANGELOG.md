...
* **database:** upgrade mongodb -> 3.1 ([fd077d1](https://github.com/hokify/agenda/commit/fd077d13170f196db9603d8ef0bf8777339acf30))
...
* add `lastModifiedBy` update when lock job ([fb1829d](https://github.com/hokify/agenda/commit/fb1829dd2e8a28a010144c7f65a9de04eac30a2a))
...
* **database:** use db() syntax rather than pulling dbName from client ([b811523](https://github.com/hokify/agenda/commit/b811523e5245c0e6885f7a6257d3483435ae5210))
...
* make agenda.cancel no longer require a callback ([5f895e3](https://github.com/hokify/agenda/commit/5f895e374b52cc9307b79f951cf5115293869354)), closes [#249](https://github.com/hokify/agenda/issues/249)
